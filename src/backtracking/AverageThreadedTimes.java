 ...
 * prints out the line it failed to find a solution on. It
 * does this using the multi-threaded backtracker instead of
 * the usual, single-threaded solver.
 * @author Timothy Geary
 */
public class AverageThreadedTimes{
    private static int totNumGoal = 0;
    ...
    public static void timeSolvingFor(String difficulty) throws FileNotFoundException{
        ...
        for(int line=1; line < 10001; line++){
            ...
            if(timing < 0.01){     numGoal++;              totNumGoal++;}
            else if(timing < 0.1){ numInstantaneous++;     totNumInstantaneous++;}
        ...
        if(numGoal>0)            System.out.println("\tGoal time (<0.01s):     " + numGoal);
    ...
    public static void main(String[] args) throws FileNotFoundException{
        ...
        System.out.println("Goal time (<0.01s):     " + totNumGoal);
